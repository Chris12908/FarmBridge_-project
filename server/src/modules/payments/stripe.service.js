...
let StripeService = class StripeService {
    constructor(configService) {
        ...
        const secretKey = this.configService.getOrThrow('stripe.secretKey');
    ...
    constructWebhookEvent(rawBody, sig) {
        const webhookSecret = this.configService.getOrThrow('stripe.webhookSecret');
