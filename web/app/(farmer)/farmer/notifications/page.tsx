...
const ICON_MAP: Record<NotificationType, string> = {
  ...
  [NotificationType.ORDER_DELIVERED]: 'verified',
...
const COLOR_MAP: Record<NotificationType, string> = {
  ...
  [NotificationType.SYSTEM]: 'bg-slate-100 text-slate-500',
};
...
function NotificationItem({
  ...
  const linkTo = notif.data?.linkTo as string | undefined;
  ...
  return <div className="hover:bg-neutral-sage/40 transition-colors cursor-default">{content}</div>;
}
